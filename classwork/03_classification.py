...
Original file is located at
    https://colab.research.google.com/github/ageron/handson-mlp/blob/main/03_classification.ipynb
...
# OpenML's mnist_784 download kept failing, so load MNIST from Keras instead.
# Build the same X (70000, 784) float array and string labels the rest of the
# notebook expects; Keras already splits 60000 train / 10000 test.
(X_tr, y_tr), (X_te, y_te) = keras.datasets.mnist.load_data()
X = np.concatenate([X_tr, X_te]).reshape(-1, 784).astype(np.float64)
y = np.concatenate([y_tr, y_te]).astype(str)
X
...
seven_index = (y == '7').argmax()   # first image whose label is "7"
...
# extra code – this cell generates Figure 3–9
